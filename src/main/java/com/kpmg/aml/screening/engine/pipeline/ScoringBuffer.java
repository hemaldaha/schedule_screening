...
public class ScoringBuffer {
    ...
    public record ScoringPayload(CustomerInfo customer, List<ScreeningCandidate> candidates, ScreeningMode mode, long scenarioId, String runId) {

    }

    private static final ScoringPayload POISON_PILL = new ScoringPayload(null, null, null, 0, null);
